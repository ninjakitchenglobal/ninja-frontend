        ...
        <section className="mt-30 px-10 md:mt-50">
          ...
          <section className="text-gray-700">
            <div className=" mx-auto border-2 border-gray-400 p-5 rounded-lg">
              ...
              <div className="bg-slate-600 text-white font-semibold text-sm md:text-base rounded-lg mx-auto mt-5 p-2 text-center">
                <p>Zelle email: amybm4760@gmail.com</p>
                <p>Account name: Amelia Moss</p>
              </div>
